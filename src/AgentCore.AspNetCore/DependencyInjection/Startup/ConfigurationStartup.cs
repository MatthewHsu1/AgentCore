...
/// <param name="Warnings">
/// Every partial-coverage warning check 5 raises, and section 10's two ambiguity warnings (K33,
/// K39). <see cref="ConfigurationStartup"/> no longer discards these — a caller logs
