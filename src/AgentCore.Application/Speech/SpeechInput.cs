...
/// </para>
/// </remarks>
public abstract record SpeechInput
{
    private protected SpeechInput()
    {
    }
    ...
    /// </param>
    public sealed record Utterance(string Text, string Language, bool IsFinal) : SpeechInput;
    ...
    public sealed record Keypress(string Key) : SpeechInput;
    ...
    /// </param>
    public sealed record Barge(string HeardText, TimeSpan PlayedDuration) : SpeechInput;
}
