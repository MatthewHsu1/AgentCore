...
/// <summary>What one call needs to open its speech channel.</summary>
...
/// </remarks>
public sealed record SpeechChannelContext(string CallId, IReadOnlyDictionary<string, string>? CustomParameters);
