...
/// The settled answer still arrives as a <see cref="CallInput.Barge"/> on the input stream, and
/// every settle path after <see cref="ICallOutputPort.StopAsync"/> carries a two-second
...
public sealed record CallChannel(ICallInputPort Input, ICallOutputPort Output) : IAsyncDisposable
{
