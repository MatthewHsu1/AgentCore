...
/// <remarks>
/// <para>
/// One instance serves one call and is disposed with it, as <see cref="ISpeechInputPort"/> is.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public interface ISpeechOutputPort : IAsyncDisposable
{
    ...
    /// <see cref="SpeechInput.Barge"/> on the input stream. A vendor that reports the cut itself
