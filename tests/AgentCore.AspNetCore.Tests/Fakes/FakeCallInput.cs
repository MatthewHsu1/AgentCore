...
internal sealed class FakeCallInput(params CallInput[] script) : ICallInputPort
{
    ...
    /// cancelled read throws instead, which is the rule <see cref="ICallInputPort.ListenAsync"/>
    ...
    private async IAsyncEnumerable<CallInput> ReplayAsync(
